...
namespace Nop.Plugin.Widgets.FocusArea.Models
{
    public class ConfigurationModel : BaseNopModel
    {
        public int ActiveStoreScopeConfiguration { get; set; }

        [NopResourceDisplayName("Plugins.Widgets.FocusArea.BoxPicture")]
        [UIHint("Picture")]
        public int BoxPictureId { get; set; }
        public bool BoxPictureId_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.FocusArea.BoxLink")]
        [AllowHtml]
        public string BoxLink { get; set; }
        public bool BoxLink_OverrideForStore { get; set; }

        [NopResourceDisplayName("Plugins.Widgets.FocusArea.Picture")]
        [UIHint("Picture")]
        public int Picture1Id { get; set; }
        public bool Picture1Id_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.FocusArea.Text")]
        [AllowHtml]
        public string Text1 { get; set; }
        public bool Text1_OverrideForStore { get; set; }
        [NopResourceDisplayName("Plugins.Widgets.FocusArea.Link")]
        [AllowHtml]
